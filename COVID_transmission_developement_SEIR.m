function D = COVID_transmission_developement_SEIR(D,PM,PI,PT,PD,ct)
    ...
    % exposed -------------------------------------------------------------
    dS_2_Eu_corona         = D.S_corona(ct)   .* prob_corona;
    dS_2_Eu_flu            = D.S_flu(ct)      .* prob_flu;
    
    % show symptoms -------------------------------------------------------
    dEu_2_Iu_corona        = D.Eu_corona(ct)  .* PD.Eu_2_Iu_corona;
    dEu_2_Iu_flu           = D.Eu_flu(ct)     .* PD.Eu_2_Iu_flu;
    ...
    D.S_corona(ct+1)       = D.S_corona(ct)   - dS_2_Eu_corona;  
    D.S_flu(ct+1)          = D.S_flu(ct)      + dR_2_S_flu        - dS_2_Eu_flu;
    
    D.Eu_corona(ct+1)      = D.Eu_corona(ct)  + dS_2_Eu_corona    - dEu_2_Iu_corona;
    D.Eu_flu(ct+1)         = D.Eu_flu(ct)     + dS_2_Eu_flu       - dEu_2_Iu_flu;
    
    D.Iu_corona(ct+1)      = D.Iu_corona(ct)  + dEu_2_Iu_corona   + dISu_2_Iu_corona  - dIu_2_ISu_corona - dIu_2_R_corona;
    ...
    D.Iu_flu(ct+1)         = D.Iu_flu(ct)     + dEu_2_Iu_flu      + dISu_2_Iu_flu     - dIu_2_ISu_flu    - dIu_2_R_flu;
